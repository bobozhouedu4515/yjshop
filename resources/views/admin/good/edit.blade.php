                    ...
                    <div class="row">
                        <div class="card col-8">
                            ...
                            <div class="form-group">
                                <label>商品类目</label>
                                <input type="text" name="name" value="{{$good->name}}" class="form-control" placeholder="填写商品类目">
                            </div>
                            <div class="form-group">
                                <label>商品价格</label>
                                <input type="text" name="name" value="{{$good->price}}" class="form-control" placeholder="填写商品价格">
                            </div>
                            <div class="form-group">
                                <label>选择类目</label>
                                <select class="custom-select col-12" name="product_id" id="inlineFormCustomSelect">
                                    ...
                                    @foreach($products as $v)
                                        <option  @if($good['product_id']==$v['id']) selected  @endif value="{{$v['id']}}">{!! $v['_name'] !!}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="layui-upload-drag" id="test1">
                                        ...
                                        <a href="#" onclick="del()" class="fa fa-close text-danger"> <img src="{{$good->picture}}" alt="" width="150"></a>
                                        <p>点击上传，或将文件拖拽到此处</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label>商品描述</label>
                                <textarea name="description" class="form-control" rows="2" >{{$good->description}}</textarea>
                            </div>
                            {{--编辑器--}}
                            <div class="form-group">
                                <label>商品详情</label>
                        ...
                        <div id="app" class="card col-4">
                            <div class="card-body" v-for="(v,k) in specs">
                                <div class="form-group">
                                    ...
                                    <input type="text"  v-model="v.spec" class="form-control" placeholder="填写商品规格">
                                </div>
                                <div class="form-group">
                                    <label>商品颜色</label>
                                    <input type="text"  v-model="v.color" class="form-control" placeholder="填写商品颜色">
                                </div>
                                <div class="form-group">
                                    <label>商品库存</label>
