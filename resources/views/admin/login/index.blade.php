...
<head>
    ...
    <link href=" {{asset ('org/assets/css')}}/colors/green-dark.css" id="theme" rel="stylesheet">
...
<!-- ============================================================== -->
<section id="wrapper">
    <div class="login-register" style="background-image:url({{asset ('org/assets')}}/images/background/login-register.jpg);">
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{route ('admin.login.login_store')}}" method="post">
                    @csrf
                    <h3 class="box-title m-b-20">登录</h3>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="username" value="bobozhou" placeholder="昵称"> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control" type="password" name="password" value="admin888" placeholder="密码"> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
