        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                ...
                <ol class="breadcrumb " style="color: white">
                    ...
                    <li class="breadcrumb-item active">修改类目</li>
                </ol>
            </div>
        </div>
        {{--表单--}}
                ...
                <div class="card-body">
                    ...
                    <div class="card ">
                        ...
                        <div class="form-group">
                            <label>商品类名</label>
                            <input type="text" name="name" value="{{$product->name}}" class="form-control" placeholder="填写商品类目">
                        </div>
                        <div class="form-group">
                            <label>选择类目</label>
                            ...
                            <select class="custom-select col-12" name="pid" id="inlineFormCustomSelect">
                                ...
                                @foreach($products as $v)
                                    <option @if($product['pid']==$v['id']) selected @endif  value="{{$v['id']}}">{!! $v['_name'] !!}</option>
                                @endforeach
                            </select>
