...
<div id="header">
    <div class="header-box">
        ...
        <ul class="header-right">
            <li class="denglu">
                <div>
                    <a class="" href="JavaScript:;">{{auth ()->user ()->name}}</a>
                </div>
            </li>
            <li class="shu"></li>
            <li class="denglu"><a class="" href="{{route ('home.user.logout')}}">退出</a></li>
    ...
    <div class="beij_center">
        ...
        <div class="nav_r">
            ...
            <div id="settleup_2014">
                <div class="cw_icon">
                    <a href="{{route ('home.cart.index')}}"><span>购物车<em></em>{{$_carts->where('user_id',auth ()->id ())->count()}}
                            件</span></a>
                    <i class="ci-right ">
                        <s class="jt">◇</s>
                    </i>
            ...
            <div class="tod_tongc_zuoc">
                    ...
                    <div class="myGome_accountSecurity">
                        ...
                        <div class="verifiBox fl_ee">
                            <div class="shab_1">
                                ...
                                <p class="myGome_verifiPop"><span>您已绑定手机：</span> <span>182****0710</span> <a href="#"
                                                                                                             target="_blank">管理</a>
                                </p>
                            </div>
                            <div class="shab_1">
                                <span class="myGome_email" val="email"> <em class=""></em> </span>
                                <p class="myGome_verifiPop"><span>您还未绑定邮箱 </span><a href="#" target="_blank">立即绑定</a>
                                </p>
                            </div>
                        </div>
                ...
                <div class="wod_tongc_daoh_lieb">
                    <div class="diy_top">
                        <ul>
                            <h3>订单中心</h3>
                            <li><a href="{{route ('home.order.my_order')}}">我的订单</a></li>
                            <li><a href="#">退换货单</a></li>
                            <li><a href="#">评价晒单</a></li>
                        </ul>
                        <ul>
